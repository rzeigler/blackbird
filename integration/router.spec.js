            ...
            Path.Route(shorthand("/a/:id/"), dispatcher({
                get: R.cond([
                    [R.compose(R.propEq("id", "a"), R.prop("params")),
                        () => makeResponse(200, {}, a.toString())],
                    [R.compose(R.propEq("id", "b"), R.prop("params")),
                        () => makeResponse(200, {}, b.toString())],
                    [R.T, (ctx) => Promise.reject(makeResponse(404, {}, ctx.params.toString()))]
                ]),
                post: R.cond([
                    [R.compose(R.propEq("id", "a"), R.prop("params")),
                        () => {
                            a = 0;
                            return makeResponse(200, {}, a.toString());
                        }],
                    [R.compose(R.propEq("id", "b"), R.prop("params")),
                        () => {
                            b = 0;
                            return makeResponse(200, {}, b.toString());
                        }],
                    [R.T, (ctx) => Promise.reject(makeResponse(404, {}, ctx.params.toString()))]
                ])
            })),
